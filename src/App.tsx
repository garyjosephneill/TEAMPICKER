              ...
              <div>
                ...
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{ display: 'block' }}>
                    {/* Outer circle */}
                    <circle cx="12" cy="12" r="11" stroke="var(--color-t-c4)" strokeWidth="1.5"/>
                    {/* Centre pentagon */}
                    <polygon points="12,7.5 15.4,9.8 14.1,13.6 9.9,13.6 8.6,9.8" fill="var(--color-t-c4)"/>
                    {/* Five seam lines from pentagon vertices to edge */}
                    <line x1="12" y1="7.5" x2="12" y2="1" stroke="var(--color-t-c4)" strokeWidth="1.5"/>
                    <line x1="15.4" y1="9.8" x2="20.5" y2="7" stroke="var(--color-t-c4)" strokeWidth="1.5"/>
                    <line x1="14.1" y1="13.6" x2="18" y2="18" stroke="var(--color-t-c4)" strokeWidth="1.5"/>
                    <line x1="9.9" y1="13.6" x2="6" y2="18" stroke="var(--color-t-c4)" strokeWidth="1.5"/>
                    <line x1="8.6" y1="9.8" x2="3.5" y2="7" stroke="var(--color-t-c4)" strokeWidth="1.5"/>
                  </svg>
                </button>
              </div>
            </div>
