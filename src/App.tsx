...
export default function App() {
  ...
  const KITS = [
    ...
    { name: 'WOLVES',           bg: '#F7A51E', c1: '#FFFFFF', c2: '#231F20', c3: '#FFFFFF', c4: '#231F20' },
  ];
        ...
        <header ref={headerRef} className="sticky top-0 z-10 bg-t-bg pt-8 pb-4 shrink-0 overflow-x-hidden" style={{ paddingLeft: 'max(16px, env(safe-area-inset-left))', paddingRight: 'max(16px, env(safe-area-inset-right))' }}>
          ...
          <div className="mb-[11px] flex items-center justify-between">
            ...
            <button
              ...
              style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, opacity: view === 'settings' ? 1 : 0.75, flexShrink: 0, alignSelf: 'center', filter: activeKit?.lightBg ? 'invert(1)' : 'none' }}
            >
