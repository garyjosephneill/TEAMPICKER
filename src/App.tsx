  ...
  useEffect(() => {
    ...
    const typeNext = () => {
      ...
      if (charIndex < PLACEHOLDER_FULL.length) {
        ...
        // fully typed — pause 2s, clear, pause 1s, restart
        timeout = setTimeout(() => {
          setPlaceholderText('');
      ...
      if (isOpening) {
        setTimeout(() => {
          ...
          if (card && main && header) {
            ...
            main.scrollTo({ top: cardTop - headerHeight - 6, behavior: 'smooth' });
          }
        }, 50);
      }
      return next;
            ...
            <div>
              ...
              <div ref={addRowRef} className="flex gap-2 pt-2 pb-4">
                <input
                  ...
                  className="flex-1 bg-t-bg border-2 border-t-c2 text-t-c1 uppercase outline-none px-2 font-bold animated-placeholder"
