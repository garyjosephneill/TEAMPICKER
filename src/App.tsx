            ...
            <div>
              ...
              <div ref={addRowRef} className="flex gap-2 pt-2 pb-4">
                <input
                  ...
                  className="flex-1 bg-t-bg border-2 border-t-c2 text-t-c1 uppercase outline-none px-2 font-bold"
              ...
              <div className="relative">
                ...
                {transferCandidate && (
                  <div
                    ...
                    style={{ backgroundColor: 'var(--color-t-bg)' }}
                  />
                )}
              </div>
