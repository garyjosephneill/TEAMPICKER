...
export default function App() {
  ...
  const KITS = [
    ...
    { name: 'ASTON VILLA',      bg: '#95BFE5', c1: '#ffffff', c2: '#670E36', c3: '#ffffff', c4: '#670E36' },
    { name: 'BOURNEMOUTH',      bg: '#DA291C', c1: '#ffffff', c2: '#000000', c3: '#ffffff', c4: '#000000' },
    ...
    { name: 'FULHAM',           bg: '#ffffff', c1: '#000000', c2: '#ce0007', c3: '#CC0000', c4: '#ce0007' },
    ...
    { name: 'LIVERPOOL',        bg: '#C8102E', c1: '#ffffff', c2: '#f8e86a', c3: '#F6EB61', c4: '#027061' },
    { name: 'MAN CITY',         bg: '#6CABDD', c1: '#ffffff', c2: '#1C2C5B', c3: '#ffffff', c4: '#1C2C5B' },
    { name: 'MAN UTD',          bg: '#DA291C', c1: '#000000', c2: '#FBE122', c3: '#ffffff', c4: '#FBE122' },
    { name: 'NEWCASTLE',        bg: '#241F20', c1: '#ffffff', c2: '#ffffff', c3: '#41B0E4', c4: '#41B0E4' },
    { name: 'NOTT\'M FOREST',   bg: '#DD0000', c1: '#ffffff', c2: '#ffffff', c3: '#000000', c4: '#000000' },
